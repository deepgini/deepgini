...
def exp(coverage,use_adv,std=0,k=1,k_bins=1000):
    ...
    if coverage=='kmnc':
        pass
        #df.to_csv('./output_fashion/{}_{}_k_bins_{}.csv'.format(dataset,coverage,k_bins))
    elif coverage=='nbc':
        pass
        #df.to_csv('./output_fashion/{}_{}_std_{}.csv'.format(dataset,coverage,std))
    elif coverage=='snac':
        pass
        #df.to_csv('./output_fashion/{}_{}_std_{}.csv'.format(dataset,coverage,std))
    elif coverage=='tknc':
        pass
        #df.to_csv('./output_fashion/{}_{}_k_{}.csv'.format(dataset,coverage,k))
...
def exp_nac(use_adv,t):
    ...
    #df.to_csv('./output_fashion/{}_nac_t_{}.csv'.format(dataset,t))
...
def exp_deep_metric(use_adv):
    ...
    if use_adv:
        ...
        dataset='fashion'
    #df.to_csv('./output_fashion/{}_deep_metric.csv'.format(dataset))
